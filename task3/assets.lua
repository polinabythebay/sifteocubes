...
Task1_Icon = image{"assets/task1icon.png"}
Task2_Icon = image{"assets/task2icon.png"}
Task3_Icon = image{"assets/task3icon.png"}
Task4_Icon = image{"assets/task4icon.png"}
Task5_Icon = image{"assets/task5icon.png"}
Task6_Icon = image{"assets/task6icon.png"}
